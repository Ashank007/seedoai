...
const AttendanceGraph_Faculty: React.FC<Props> = ({ data, darkMode,selectedId,onClose }) => {
  const graphData = React.useMemo(() => {
    const filteredData = selectedId
      ? data.filter(d => d.facultyid === selectedId)
      : data;
...
export default AttendanceGraph_Faculty;
